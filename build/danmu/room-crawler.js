...
var RoomCrawler = /** @class */ (function (_super) {
    ...
    RoomCrawler.prototype.query = function () {
        var _this = this;
        var fixedRooms = this.collector_.getFixedRooms();
        var dynamicRooms = (function () { return __awaiter(_this, void 0, void 0, function () {
            var roomInfoList, rooms, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_1 = _a.sent();
                        index_1.cprint("(Collector) - " + error_1.message, chalk.red);
                        return [3 /*break*/, 3];
...
exports.RoomCrawler = RoomCrawler;
